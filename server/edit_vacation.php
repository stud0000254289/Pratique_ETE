...
if ($id === null || $employeeId === null || $startDate === null || $endDate === null || $days === null) {
...
$sql = "UPDATE vacations SET employee_id='$employeeId', start_date='$startDate', end_date='$endDate', days='$days' WHERE id='$id'";
